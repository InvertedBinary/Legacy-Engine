...
public class Sprite {
	 ...
	 * 
	 * int width = (int) (sprite.width); int height = (int) (sprite.height); int[]
	 * pixels = new int[width * height]; for (int y = 0; y < height; y++){ for (int
	 * x = 0; x < width; x++){ pixels[x + y * width] = sprite.pixels[(int) y + x *
	 * sprite.width]; } } Sprite rSprite = new Sprite(pixels, width, height);
	 * 
	 * return rSprite; }
	 * 
