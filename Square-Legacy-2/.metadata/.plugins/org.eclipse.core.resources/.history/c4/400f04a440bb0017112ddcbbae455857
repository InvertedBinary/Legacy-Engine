...
import com.IB.SL.level.Level;
	...
	public class bow_Crimson extends Weapon {
		
		public bow_Crimson(int x, int y, int life, int amount, int slot) {
			RNGGen();
			this.x = x;
			this.y = y;
			this.xx = x;
		...
		public bow_Crimson(int slot) {
			RNGGen();
			basicInitialization(slot);
		}
		
		public void basicInitialization(int slot) {
			this.sprite = Sprite.bow_Crimson;
			this.name = "Crimson Longbow";
			this.dropchance = -1;
			this.rarity = 0;
			this.price = "950";
			this.slot = slot;
