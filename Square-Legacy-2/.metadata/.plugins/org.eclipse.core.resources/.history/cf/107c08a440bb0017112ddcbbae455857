...
import com.IB.SL.level.Level;
	...
	public class bow_FlamingLongbow extends Weapon {
		
		public bow_FlamingLongbow(int x, int y, int life, int amount, int slot) {
			RNGGen();
			this.x = x;
			this.y = y;
			this.xx = x;
		...
		public bow_FlamingLongbow(int slot) {
			RNGGen();
			basicInitialization(slot);
		}
		
		public void basicInitialization(int slot) {
			this.sprite = Sprite.bow_Flaming;
			this.name = "Flaming Longbow";
			this.dropchance = -1;
			this.rarity = 0;
			this.price = "730";
			this.slot = slot;
