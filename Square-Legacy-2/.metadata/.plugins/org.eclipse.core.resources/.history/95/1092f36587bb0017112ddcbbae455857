...
public class PurpleFairy extends Mob {

	transient private AnimatedSprite anim = new AnimatedSprite(SpriteSheet.PurpleFairy_anim, 16, 16, 2);
	...
	transient int blinkTimer;

	public PurpleFairy(int x, int y) {
		this.maxhealth = 4;
