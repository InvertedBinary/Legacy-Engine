...
public class EarthEsscence extends Item{
	
	public EarthEsscence(int x, int y, int life, int amount) {
		this.x = x;
		this.y = y;
		this.xx = x;
		this.yy = y;
	...
	public EarthEsscence() {
		basicInitialization();
	}
	
	public void basicInitialization() {
		this.sprite = Sprite.EarthEsscence;
		this.name = "Earth Esscence";
		this.price = "175";
		this.desc = "Craft\nItem";
		this.stackSize = 8;
