...
public class FairyWingsmith extends Mob{
	
	transient private AnimatedSprite anim = new AnimatedSprite(SpriteSheet.FairyWingsmith_anim, 16, 16, 2);

	
	transient private GUI gui;
	transient List<Entity> entities;
	
	transient private AnimatedSprite animSprite = anim;
	transient double xa = 0;
	transient double ya = 0;
	transient double time = 0;
	transient int fireRate = 0;
	transient int blinkRate = 0;
	...
	public FairyWingsmith(int x, int y) {
		this.maxhealth = 25;
    ...
    private void updateShooting() {
        ...
        if ((players.size() > 0) && fireRate <= 0) {
            ...
            fairyBolt(x, y + 4, dir);
            fairyFireBolt(x, y + 4, dir + Math.PI / 9);
            fairyStunBolt(x, y + 4, dir - Math.PI / 9);
    ...
    private void updateBlast() {
        ...
        if ((players.size() > 0) && blastRate <= 0) {
            ...
            double dy = py - sy;
            double dir = Math.atan2(dy, dx);
            fairyBolt(x + Math.random() * 80 - 40, y + Math.random() * 80 - 40, Math.random() * Math.PI);
            fairyFireBolt(x + Math.random() * 80 - 40, y + Math.random() * 80 - 40, Math.random() * Math.PI);
            fairyStunBolt(x + Math.random() * 80 - 40, y + Math.random() * 80 - 40, Math.random() * Math.PI);
            fairyBolt(x + Math.random() * 80 - 40, y + Math.random() * 80 - 40, Math.random() * Math.PI);
            fairyFireBolt(x + Math.random() * 80 - 40, y + Math.random() * 80 - 40, Math.random() * Math.PI);
            fairyStunBolt(x + Math.random() * 80 - 40, y + Math.random() * 80 - 40, Math.random() * Math.PI);
            fairyBolt(x + Math.random() * 80 - 40, y + Math.random() * 80 - 40, Math.random() * Math.PI);
