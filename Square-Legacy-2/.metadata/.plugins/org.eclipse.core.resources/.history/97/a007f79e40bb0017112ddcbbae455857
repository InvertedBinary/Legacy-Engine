...
public class ArcaneEsscence extends Item{
	
	public ArcaneEsscence(int x, int y, int life, int amount) {
		this.x = x;
		this.y = y;
		this.xx = x;
		this.yy = y;
	...
	public ArcaneEsscence() {
		basicInitialization();
	}
	
	public void basicInitialization() {
		this.sprite = Sprite.ArcaneEsscence;
		this.name = "Arcane Esscence";
		this.price = "200";
		this.desc = "Craft\nItem";
		this.stackSize = 8;
