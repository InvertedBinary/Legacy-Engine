...
import com.IB.SL.level.Level;
	...
	public class bow_BirchShort extends Weapon {
		
		public bow_BirchShort(int x, int y, int life, int amount, int slot) {
			RNGGen();
			this.x = x;
			this.y = y;
			this.xx = x;
		...
		public bow_BirchShort(int slot) {
			RNGGen();
			basicInitialization(slot);
		}
		
		public void basicInitialization(int slot) {
			this.sprite = Sprite.bow_BirchShort;
			this.name = "Birch Shortbow";
			this.dropchance = -1;
			this.rarity = 0;
			this.price = "450";
			this.slot = slot;
