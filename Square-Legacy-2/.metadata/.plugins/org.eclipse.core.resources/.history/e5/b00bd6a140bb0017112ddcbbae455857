...
import com.IB.SL.level.Level;
	...
	public class Pentagram extends EquipableItem{
		int use = 0;
		public Pentagram(int x, int y, int life, int amount, int slot) {
			RNGGen();
			this.x = x;
			this.y = y;
			this.xx = x;
		...
		public Pentagram(int slot) {
			RNGGen();
			basicInitialization(slot);
		}
		
		public void basicInitialization(int slot) {
			this.sprite = Sprite.Pentagram;
			this.name = "Pentagram";
			this.dropchance = -1;
			this.rarity = 0;
			this.price = "580";
