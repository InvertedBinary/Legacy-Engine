...
public class SageBolt extends Projectile {
	...
	public SageBolt(double x, double y, double dir) {
		super(x, y, dir);
		damage = 1;
		basicInitialization();
	}
	
	public SageBolt(double x, double y, double dir, Mob mob) {
		super(x, y, dir);
		damage = 1 + (mob.stat_MAT / 10) + (mob.stat_MDF / 11);
		basicInitialization();
	}
	...
	public void basicInitialization() {
		...
		speed = 10;
		sprite = Sprite.rotate(Sprite.SagesBolt, angle);	
		manaCost = 0;
