...
import com.IB.SL.level.Level;
	...
	public class tome_Glowing extends Weapon {
		
		private transient  AnimatedSprite down;
		
		public tome_Glowing(int x, int y, int life, int amount, int slot) {
			RNGGen();
			this.x = x;
			this.y = y;
			this.xx = x;
