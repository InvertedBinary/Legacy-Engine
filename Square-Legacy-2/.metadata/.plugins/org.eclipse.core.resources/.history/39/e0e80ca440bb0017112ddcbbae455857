...
import com.IB.SL.entity.projectile.IceArrow;
import com.IB.SL.entity.projectile.Projectile;
import com.IB.SL.graphics.Screen;
import com.IB.SL.graphics.Sprite;
import com.IB.SL.level.Level;

	public class bow_Frosted extends Weapon {
		
		public bow_Frosted(int x, int y, int life, int amount, int slot) {
			RNGGen();
			this.x = x;
			this.y = y;
			this.xx = x;
		...
		public bow_Frosted(int slot) {
			RNGGen();
			basicInitialization(slot);
		}
		
		public void basicInitialization(int slot) {
			this.sprite = Sprite.bow_Frosted;
		...
		public void attack(Projectile p, Weapon w, Mob origin) {
			...
			p = new IceArrow(x, y, this.angle(), origin);
