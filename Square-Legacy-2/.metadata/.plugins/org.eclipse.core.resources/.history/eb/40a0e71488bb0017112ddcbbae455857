...
public class BeetleSting extends Projectile{
	
	public static int FIRE_RATE = 120;
	public static int time = 0;
	public BeetleSting(double x, double y, double dir) {
		super(x, y, dir);
		range = random.nextInt(90) + 140;
		speed = 1;
		damage = 9;
		sprite = Sprite.rotate(Sprite.DesertBeetleBolt, angle);
	...
	public void addEffect(PlayerMP player) {
		player.effects.addEffect(new Stun(player, 80));
	}
