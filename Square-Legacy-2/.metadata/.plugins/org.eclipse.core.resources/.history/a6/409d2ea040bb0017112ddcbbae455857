...
public class DrySlow extends Projectile {
	...
	public DrySlow(double x, double y, double dir) {
		super(x, y, dir);
		damage = 1;
		basicInitialization();
	}
	
	public DrySlow(double x, double y, double dir, Mob mob) {
		super(x, y, dir);
		damage = 0;
		basicInitialization();
	}
	...
	protected void doEffect(Entity e) {
		e.effects.addEffect(new Slow(e, 180));
	}
