...
public class FireElemental extends Mob{
	...
	transient private AnimatedSprite down = new AnimatedSprite(SpriteSheet.FireElemental_down, 16, 16, 3);
	transient private AnimatedSprite up = new AnimatedSprite(SpriteSheet.FireElemental_up, 16, 16, 3);
	transient private AnimatedSprite left = new AnimatedSprite(SpriteSheet.FireElemental_left, 16, 16, 3);
	transient private AnimatedSprite right = new AnimatedSprite(SpriteSheet.FireElemental_right, 16, 16, 3);
    ...
    private void updateBlast() {
        ...
        if ((players.size() > 0) && blastRate <= 0) {
            ...
            fireBlast(x + Math.random() * 160 - 80, y + Math.random() * 160 - 80, Math.random() * Math.PI);
            fireBlast(x + Math.random() * 160 - 80, y + Math.random() * 160 - 80, Math.random() * Math.PI);
            fireBlast(x + Math.random() * 160 - 80, y + Math.random() * 160 - 80, Math.random() * Math.PI);
            fireBlast(x + Math.random() * 160 - 80, y + Math.random() * 160 - 80, Math.random() * Math.PI);
            fireBlast(x + Math.random() * 160 - 80, y + Math.random() * 160 - 80, Math.random() * Math.PI);
