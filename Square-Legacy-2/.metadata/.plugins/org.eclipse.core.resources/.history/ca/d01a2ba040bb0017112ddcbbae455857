...
public class DryIce extends Projectile {
	...
	public DryIce(double x, double y, double dir) {
		super(x, y, dir);
		damage = 1;
		basicInitialization();
	}
	
	public DryIce(double x, double y, double dir, Mob mob) {
		super(x, y, dir);
		damage = 0;
		basicInitialization();
	}
	...
	protected void doEffect(Entity e) {
		e.effects.addEffect(new freeze(e, 120));
	}
