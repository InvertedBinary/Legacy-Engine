...
public class ThunderEsscence extends Item{
	
	public ThunderEsscence(int x, int y, int life, int amount) {
		this.x = x;
		this.y = y;
		this.xx = x;
		this.yy = y;
	...
	public ThunderEsscence() {
		basicInitialization();
	}
	
	public void basicInitialization() {
		this.sprite = Sprite.ThunderEsscence;
		this.name = "Thunder Esscence";
		this.price = "175";
		this.desc = "Craft\nItem";
		this.stackSize = 8;
