...
public class SilversmithBolt extends Projectile {
	...
	public SilversmithBolt(double x, double y, double dir) {
		super(x, y, dir);
		damage = 1;
		basicInitialization();
	}
	
	public SilversmithBolt(double x, double y, double dir, Mob mob) {
		super(x, y, dir);
		damage = 1 + (mob.stat_ATC / 4);
		basicInitialization();
	}
	...
	public void basicInitialization() {
		...
		speed = 15;
		sprite = Sprite.rotate(Sprite.SilversmithBolt, angle);	
		manaCost = 0;
