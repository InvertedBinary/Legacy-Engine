...
public class Cultist extends Mob {
	...
	private transient AnimatedSprite down = new AnimatedSprite(SpriteSheet.Cultist_down,
			16, 16, 2);
	private transient AnimatedSprite up = new AnimatedSprite(SpriteSheet.Cultist_up, 16,
			16, 3);
	private transient AnimatedSprite left = new AnimatedSprite(SpriteSheet.Cultist_left,
			16, 16, 2);
	private transient AnimatedSprite right = new AnimatedSprite(SpriteSheet.Cultist_right, 16, 16, 2);
