...
import com.IB.SL.level.Level;
	...
	public class bow_SilverwoodShort extends Weapon {
		
		public bow_SilverwoodShort(int x, int y, int life, int amount, int slot) {
			RNGGen();
			this.x = x;
			this.y = y;
			this.xx = x;
		...
		public bow_SilverwoodShort(int slot) {
			RNGGen();
			basicInitialization(slot);
		}
		
		public void basicInitialization(int slot) {
			this.sprite = Sprite.bow_SilverwoodShort;
			this.name = "Silverwood Shortbow";
			this.dropchance = -1;
			this.rarity = 0;
			this.price = "970";
			this.slot = slot;
