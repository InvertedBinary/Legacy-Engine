...
public class TrappersOrb extends Projectile {
	...
	public TrappersOrb(double x, double y, double dir) {
		super(x, y, dir);
		damage = 1;
		basicInitialization();
	}
	
	public TrappersOrb(double x, double y, double dir, Mob mob) {
		super(x, y, dir);
	...
	public void basicInitialization() {
		...
		sprite = /*Sprite.rotate(*/Sprite.TrappersOrb/*, angle)*/;	
		manaCost = 0;
		item = new Item();
		this.id = 4;
