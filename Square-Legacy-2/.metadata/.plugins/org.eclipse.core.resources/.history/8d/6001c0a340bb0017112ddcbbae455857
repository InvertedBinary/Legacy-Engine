...
public class WaterEsscence extends Item{
	
	public WaterEsscence(int x, int y, int life, int amount) {
		this.x = x;
		this.y = y;
		this.xx = x;
		this.yy = y;
	...
	public WaterEsscence() {
		basicInitialization();
	}
	
	public void basicInitialization() {
		this.sprite = Sprite.WaterEsscence;
		this.name = "Water Esscence";
		this.price = "175";
		this.desc = "Craft\nItem";
		this.stackSize = 8;
