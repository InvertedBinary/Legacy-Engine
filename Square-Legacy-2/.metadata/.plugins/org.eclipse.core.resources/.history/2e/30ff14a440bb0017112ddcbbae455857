...
import com.IB.SL.level.Level;
	...
	public class bow_OakShort extends Weapon {
		
		public bow_OakShort(int x, int y, int life, int amount, int slot) {
			RNGGen();
			this.x = x;
			this.y = y;
			this.xx = x;
		...
		public bow_OakShort(int slot) {
			RNGGen();
			basicInitialization(slot);
		}
		
		public void basicInitialization(int slot) {
			this.sprite = Sprite.bow_OakShort;
			this.name = "Oak Shortbow";
			this.dropchance = -1;
			this.rarity = 0;
			this.price = "110";
			this.slot = slot;
