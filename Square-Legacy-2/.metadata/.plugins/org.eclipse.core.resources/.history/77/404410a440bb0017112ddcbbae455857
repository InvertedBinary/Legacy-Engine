...
import com.IB.SL.level.Level;
	...
	public class bow_OakLong extends Weapon {
		
		public bow_OakLong(int x, int y, int life, int amount, int slot) {
			RNGGen();
			this.x = x;
			this.y = y;
			this.xx = x;
		...
		public bow_OakLong(int slot) {
			RNGGen();
			basicInitialization(slot);
		}
		
		public void basicInitialization(int slot) {
			this.sprite = Sprite.bow_OakLong;
			this.name = "Oak Longbow";
			this.dropchance = -1;
			this.rarity = 0;
			this.price = "610";
			this.slot = slot;
