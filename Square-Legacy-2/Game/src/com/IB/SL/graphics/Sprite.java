...
public class Sprite {
	...
	public static Sprite Swirly = new Sprite(TileCoord.TILE_SIZE, 12, 1, SpriteSheet.blocks);
	public static Sprite bitBrick = new Sprite(TileCoord.TILE_SIZE, 2, 2, SpriteSheet.blocks);
	public static Sprite bitMetal = new Sprite(TileCoord.TILE_SIZE, 3, 2, SpriteSheet.blocks);
	public static Sprite Bluefog = new Sprite(TileCoord.TILE_SIZE, 11, 1, SpriteSheet.blocks);
	public static Sprite BookshelfBottom = new Sprite(TileCoord.TILE_SIZE, 11, 17, SpriteSheet.blocks);
	public static Sprite BookshelfTop = new Sprite(TileCoord.TILE_SIZE, 11, 16, SpriteSheet.blocks);
	public static Sprite BrickCeiling = new Sprite(TileCoord.TILE_SIZE, 6, 16, SpriteSheet.blocks);
	public static Sprite BrickWall = new Sprite(TileCoord.TILE_SIZE, 6, 17, SpriteSheet.blocks);
	public static Sprite CaveCeiling = new Sprite(TileCoord.TILE_SIZE, 14, 16, SpriteSheet.blocks);
	public static Sprite CaveWall = new Sprite(TileCoord.TILE_SIZE, 14, 17, SpriteSheet.blocks);
	public static Sprite CobbleStone = new Sprite(TileCoord.TILE_SIZE, 2, 0, SpriteSheet.blocks);
	public static Sprite CobblestoneCeiling = new Sprite(TileCoord.TILE_SIZE, 5, 16, SpriteSheet.blocks);
	public static Sprite CobbleStoneWall = new Sprite(TileCoord.TILE_SIZE, 5, 17, SpriteSheet.blocks);
	public static Sprite ColorFlowers = new Sprite(TileCoord.TILE_SIZE, 4, 1, SpriteSheet.blocks);
	public static Sprite CrackedBrick = new Sprite(TileCoord.TILE_SIZE, 10, 1, SpriteSheet.blocks);
	public static Sprite DarkStone = new Sprite(TileCoord.TILE_SIZE, 3, 1, SpriteSheet.blocks);
	public static Sprite DeepLava = new Sprite(TileCoord.TILE_SIZE, 5, 1, SpriteSheet.blocks);
	public static Sprite DeepWater = new Sprite(TileCoord.TILE_SIZE, 11, 0, SpriteSheet.blocks);
	public static Sprite Dirt = new Sprite(TileCoord.TILE_SIZE, 15, 1, SpriteSheet.blocks);
	public static Sprite DirtCeiling = new Sprite(TileCoord.TILE_SIZE, 0, 16, SpriteSheet.blocks);
	public static Sprite DirtWall = new Sprite(TileCoord.TILE_SIZE, 0, 17, SpriteSheet.blocks);
	public static Sprite DresserBottom = new Sprite(TileCoord.TILE_SIZE, 12, 17, SpriteSheet.blocks);
	public static Sprite DresserTop = new Sprite(TileCoord.TILE_SIZE, 12, 16, SpriteSheet.blocks);
	public static Sprite Grass = new Sprite(TileCoord.TILE_SIZE, 0, 0, SpriteSheet.blocks);
	public static Sprite HellBrick = new Sprite(TileCoord.TILE_SIZE, 10, 0, SpriteSheet.blocks);
	public static Sprite HellBrickCeiling = new Sprite(TileCoord.TILE_SIZE, 2, 16, SpriteSheet.blocks);
	public static Sprite HellbrickWall = new Sprite(TileCoord.TILE_SIZE, 2, 17, SpriteSheet.blocks);
	public static Sprite HellCaveCeiling = new Sprite(TileCoord.TILE_SIZE, 0, 18, SpriteSheet.blocks);
	public static Sprite HellCaveWall = new Sprite(TileCoord.TILE_SIZE, 0, 19, SpriteSheet.blocks);
	public static Sprite Hellsand = new Sprite(TileCoord.TILE_SIZE, 6, 0, SpriteSheet.blocks);
	public static Sprite HellSandCeiling = new Sprite(TileCoord.TILE_SIZE, 2, 18, SpriteSheet.blocks);
	public static Sprite HellSandWall = new Sprite(TileCoord.TILE_SIZE, 2, 19, SpriteSheet.blocks);
	public static Sprite Hellstone = new Sprite(TileCoord.TILE_SIZE, 1, 0, SpriteSheet.blocks);
	public static Sprite Ice = new Sprite(TileCoord.TILE_SIZE, 0, 2, SpriteSheet.blocks);
	public static Sprite IceBrick = new Sprite(TileCoord.TILE_SIZE, 8, 0, SpriteSheet.blocks);
	public static Sprite IceBrickCeiling = new Sprite(TileCoord.TILE_SIZE, 3, 16, SpriteSheet.blocks);
	public static Sprite IceBrickWall = new Sprite(TileCoord.TILE_SIZE, 3, 17, SpriteSheet.blocks);
	public static Sprite IceCaveCeiling = new Sprite(TileCoord.TILE_SIZE, 10, 16, SpriteSheet.blocks);
	public static Sprite IceCaveWall = new Sprite(TileCoord.TILE_SIZE, 10, 17, SpriteSheet.blocks);
	public static Sprite IceSand = new Sprite(TileCoord.TILE_SIZE, 5, 0, SpriteSheet.blocks);
	public static Sprite IceSandCeiling = new Sprite(TileCoord.TILE_SIZE, 1, 18, SpriteSheet.blocks);
	public static Sprite IceSandWall = new Sprite(TileCoord.TILE_SIZE, 1, 19, SpriteSheet.blocks);
	public static Sprite Lava = new Sprite(TileCoord.TILE_SIZE, 13, 0, SpriteSheet.blocks);
	public static Sprite Metal = new Sprite(TileCoord.TILE_SIZE, 0, 1, SpriteSheet.blocks);
	public static Sprite MetalCeiling = new Sprite(TileCoord.TILE_SIZE, 13, 16, SpriteSheet.blocks);
	public static Sprite MetalWall = new Sprite(TileCoord.TILE_SIZE, 13, 17, SpriteSheet.blocks);
	public static Sprite MossCeiling = new Sprite(TileCoord.TILE_SIZE, 7, 16, SpriteSheet.blocks);
	public static Sprite MossWall = new Sprite(TileCoord.TILE_SIZE, 7, 17, SpriteSheet.blocks);
	public static Sprite ObsidianCeiling = new Sprite(TileCoord.TILE_SIZE, 9, 16, SpriteSheet.blocks);
	public static Sprite ObsidianWall = new Sprite(TileCoord.TILE_SIZE, 9, 17, SpriteSheet.blocks);
	public static Sprite PathDirt = new Sprite(TileCoord.TILE_SIZE, 15, 0, SpriteSheet.blocks);
	public static Sprite Sand = new Sprite(TileCoord.TILE_SIZE, 9, 1, SpriteSheet.blocks);
	public static Sprite SandBrick = new Sprite(TileCoord.TILE_SIZE, 9, 0, SpriteSheet.blocks);
	public static Sprite SandBrickCeiling = new Sprite(TileCoord.TILE_SIZE, 1, 16, SpriteSheet.blocks);
	public static Sprite SandBrickWall = new Sprite(TileCoord.TILE_SIZE, 1, 17, SpriteSheet.blocks);
	public static Sprite SandCeiling = new Sprite(TileCoord.TILE_SIZE, 15, 16, SpriteSheet.blocks);
	public static Sprite SandWall = new Sprite(TileCoord.TILE_SIZE, 15, 17, SpriteSheet.blocks);
	public static Sprite Snow = new Sprite(TileCoord.TILE_SIZE, 2, 1, SpriteSheet.blocks);
	public static Sprite StoneBrick = new Sprite(TileCoord.TILE_SIZE, 7, 0, SpriteSheet.blocks);
	public static Sprite StoneBrickCeiling = new Sprite(TileCoord.TILE_SIZE, 8, 16, SpriteSheet.blocks);
	public static Sprite StoneBrickWall = new Sprite(TileCoord.TILE_SIZE, 8, 17, SpriteSheet.blocks);
	...
	//public static Sprite VoidTile = new Sprite(TileCoord.TILE_SIZE, 12, 1, SpriteSheet.blocks);
	...
	public static Sprite ColoredFlowers = new Sprite(TileCoord.TILE_SIZE, 17, 23, SpriteSheet.blocks);
	public static Sprite YellowFlowers = new Sprite(TileCoord.TILE_SIZE, 17, 22, SpriteSheet.blocks);
	public static Sprite Pebble = new Sprite(TileCoord.TILE_SIZE, 25, 17, SpriteSheet.blocks);
	public static Sprite BlueMushroom = new Sprite(TileCoord.TILE_SIZE, 21, 18, SpriteSheet.blocks);
	public static Sprite BlueMushroomDirt = new Sprite(TileCoord.TILE_SIZE, 22, 18, SpriteSheet.blocks);
	public static Sprite RedMushroom = new Sprite(TileCoord.TILE_SIZE, 23, 18, SpriteSheet.blocks);
	public static Sprite RedMushroomDirt = new Sprite(TileCoord.TILE_SIZE, 24, 18, SpriteSheet.blocks);
	public static Sprite GreenMushroom = new Sprite(TileCoord.TILE_SIZE, 25, 18, SpriteSheet.blocks);
	public static Sprite GreenMushroomDirt = new Sprite(TileCoord.TILE_SIZE, 26, 18, SpriteSheet.blocks);
	public static Sprite DirtPatch = new Sprite(TileCoord.TILE_SIZE, 17, 16, SpriteSheet.blocks);
	public static Sprite DarkCastle = new Sprite(TileCoord.TILE_SIZE, 19, 25, SpriteSheet.blocks);
	public static Sprite Cave = new Sprite(TileCoord.TILE_SIZE, 19, 24, SpriteSheet.blocks);
	public static Sprite Portal = new Sprite(TileCoord.TILE_SIZE, 19, 28, SpriteSheet.blocks);
	public static Sprite PathVertical = new Sprite(TileCoord.TILE_SIZE, 17, 20, SpriteSheet.blocks);
	public static Sprite PathHorizontal = new Sprite(TileCoord.TILE_SIZE, 18, 20, SpriteSheet.blocks);
	public static Sprite PathCross = new Sprite(TileCoord.TILE_SIZE, 17, 21, SpriteSheet.blocks);
	public static Sprite PathCornerTL = new Sprite(TileCoord.TILE_SIZE, 17, 18, SpriteSheet.blocks);
	public static Sprite PathCornerTR = new Sprite(TileCoord.TILE_SIZE, 18, 18, SpriteSheet.blocks);
	public static Sprite PathCornerBL = new Sprite(TileCoord.TILE_SIZE, 17, 19, SpriteSheet.blocks);
	public static Sprite PathCornerBR = new Sprite(TileCoord.TILE_SIZE, 18, 19, SpriteSheet.blocks);
	public static Sprite PathEndLeft = new Sprite(TileCoord.TILE_SIZE, 18, 24, SpriteSheet.blocks);
	public static Sprite PathEndRight = new Sprite(TileCoord.TILE_SIZE, 17, 24, SpriteSheet.blocks);
	public static Sprite PathEndTop = new Sprite(TileCoord.TILE_SIZE, 19, 23, SpriteSheet.blocks);
	public static Sprite PathEndBottom = new Sprite(TileCoord.TILE_SIZE, 18, 23, SpriteSheet.blocks);
	public static Sprite BrokenSword = new Sprite(TileCoord.TILE_SIZE, 18, 16, SpriteSheet.blocks);
	public static Sprite RedBed = new Sprite(TileCoord.TILE_SIZE, 16, 17, SpriteSheet.blocks);
	public static Sprite BlueBed = new Sprite(TileCoord.TILE_SIZE, 16, 19, SpriteSheet.blocks);
	public static Sprite GreenBed = new Sprite(TileCoord.TILE_SIZE, 16, 20, SpriteSheet.blocks);
	public static Sprite OrangeBed = new Sprite(TileCoord.TILE_SIZE, 16, 21, SpriteSheet.blocks);
	public static Sprite TopChair = new Sprite(TileCoord.TILE_SIZE, 19, 21, SpriteSheet.blocks);
	public static Sprite BottomChair = new Sprite(TileCoord.TILE_SIZE, 19, 22, SpriteSheet.blocks);
	public static Sprite LeftChair = new Sprite(TileCoord.TILE_SIZE, 18, 22, SpriteSheet.blocks);
	public static Sprite RightChair = new Sprite(TileCoord.TILE_SIZE, 18, 21, SpriteSheet.blocks);
	public static Sprite Castle = new Sprite(TileCoord.TILE_SIZE, 19, 26, SpriteSheet.blocks);
	public static Sprite Village = new Sprite(TileCoord.TILE_SIZE, 19, 27, SpriteSheet.blocks);
	public static Sprite Table = new Sprite(TileCoord.TILE_SIZE, 19, 20, SpriteSheet.blocks);
	public static Sprite Door = new Sprite(TileCoord.TILE_SIZE, 4, 0, SpriteSheet.blocks);
