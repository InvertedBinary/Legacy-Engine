...
public class FluxWisp extends Mob {

	transient private AnimatedSprite anim = new AnimatedSprite(SpriteSheet.FluxWisp_anim,
			16, 16, 2);
	...
	private void updateShooting() {
		...
		if (Explodetime > 10) {
			...
			for(int i = 0; i < players2.size(); i++) {
				level.damagePlayer((int)this.getX(), (int)this.getY(), (PlayerMP)players2.get(i), 0, 2, name, 0);
