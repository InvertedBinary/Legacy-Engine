...
public class EtherialBindingOoze extends Item{
	
	public EtherialBindingOoze(int x, int y, int life, int amount) {
		this.x = x;
		this.y = y;
		this.xx = x;
		this.yy = y;
	...
	public EtherialBindingOoze() {
		basicInitialization();
	}
	
	public void basicInitialization() {
		this.sprite = Sprite.EtherialBindingOoze;
		this.name = "Etherial Binding Ooze";
		this.price = "250";
		this.desc = "Craft\nItem";
		this.stackSize = 8;
