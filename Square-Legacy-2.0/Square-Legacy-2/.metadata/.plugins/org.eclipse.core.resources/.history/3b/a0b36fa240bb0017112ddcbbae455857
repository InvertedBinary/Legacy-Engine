...
import com.IB.SL.level.Level;
	...
	public class RingOfMinorStamina extends EquipableItem{
		int use = 0;
		public RingOfMinorStamina(int x, int y, int life, int amount, int slot) {
			this.x = x;
			this.y = y;
			this.xx = x;
			this.yy = y;
		...
		public RingOfMinorStamina(int slot) {
			basicInitialization(slot);
		}
		
		public void basicInitialization(int slot) {
			this.sprite = Sprite.ring_MinorStamina;
			this.name = "Ring of Minor Stamina";
			this.dropchance = -1;
			this.rarity = 0;
			this.price = "65";
			this.desc = "+5\nTo Max\nSP";
