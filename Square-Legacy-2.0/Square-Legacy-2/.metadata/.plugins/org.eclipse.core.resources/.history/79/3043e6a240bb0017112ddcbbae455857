...
public class Slimey extends Mob {

	transient private AnimatedSprite down = new AnimatedSprite(SpriteSheet.Slimey_down, 16, 16, 0);
	transient private AnimatedSprite up = new AnimatedSprite(SpriteSheet.Slimey_up, 16, 16, 0);
	transient private AnimatedSprite left = new AnimatedSprite(SpriteSheet.Slimey_left, 16, 16, 0);
	transient private AnimatedSprite right = new AnimatedSprite(SpriteSheet.Slimey_right, 16, 16, 0);
