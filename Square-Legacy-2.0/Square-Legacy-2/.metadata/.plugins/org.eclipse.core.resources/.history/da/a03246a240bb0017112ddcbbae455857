...
public class RefractorsBolt extends Projectile {
	...
	public RefractorsBolt(double x, double y, double dir) {
		super(x, y, dir);
		damage = 1;
		basicInitialization();
	}
	
	public RefractorsBolt(double x, double y, double dir, Mob mob) {
		super(x, y, dir);
		damage = 1 + (mob.stat_ATC / 8);
		basicInitialization();
	}
	...
	public void basicInitialization() {
		...
		speed = 1;
		sprite = Sprite.rotate(Sprite.RefractorsBolt, angle);	
		manaCost = 0;
