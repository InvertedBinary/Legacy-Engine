...
import com.IB.SL.level.Level;
	...
	public class Footwraps extends EquipableItem{
		int use = 0;
		boolean equipped = false;
		
		public Footwraps(int x, int y, int life, int amount, int slot) {
			RNGGen();
			this.x = x;
			this.y = y;
			this.xx = x;
		...
		public Footwraps(int slot) {
			basicInitialization(slot);
		}
		
		public void basicInitialization(int slot) {
			RNGGen();
			this.sprite = Sprite.legs_Footwraps;
			this.name = "Footwraps";
			this.dropchance = -1;
			this.rarity = 0;
			this.price = "640";
