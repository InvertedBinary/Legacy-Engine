...
public class BlastingBolt extends Projectile {
	...
	public BlastingBolt(double x, double y, double dir) {
		super(x, y, dir);
		damage = 1;
		basicInitialization();
	}
	
	public BlastingBolt(double x, double y, double dir, Mob mob) {
		super(x, y, dir);
		damage = 5 + (mob.stat_MAT / 2);
		basicInitialization();
	}
	...
	public void basicInitialization() {
		...
		speed = 3;
		sprite = Sprite.rotate(Sprite.BlastingBolt, angle);
		manaCost = 0;
