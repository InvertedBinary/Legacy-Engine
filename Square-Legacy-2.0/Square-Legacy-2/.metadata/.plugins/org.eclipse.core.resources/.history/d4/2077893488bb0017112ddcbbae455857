...
public class DemonOrb extends Projectile{
	
	public static int FIRE_RATE = 32;
	public static int time = 0;
	public boolean particles = false;
	
	public DemonOrb(double x, double y, double dir) {
		super(x, y, dir);
		...
		sprite = Sprite.rotate(Sprite.DemonOrb, angle);
		this.id = 54231;
	}
