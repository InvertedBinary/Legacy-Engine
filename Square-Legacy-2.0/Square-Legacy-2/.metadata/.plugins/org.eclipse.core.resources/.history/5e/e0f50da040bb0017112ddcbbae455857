...
public class DesertBeetle extends Mob{
	
	transient private AnimatedSprite down = new AnimatedSprite(SpriteSheet.DesertBeetle_down, 16, 16, 2);
	transient private AnimatedSprite up = new AnimatedSprite(SpriteSheet.DesertBeetle_up, 16, 16, 2);
	transient private AnimatedSprite left = new AnimatedSprite(SpriteSheet.DesertBeetle_left, 16, 16, 2);
	transient private AnimatedSprite right = new AnimatedSprite(SpriteSheet.DesertBeetle_right, 16, 16, 2);
	...
	public DesertBeetle(int x, int y) {
		this.maxhealth = 22;
