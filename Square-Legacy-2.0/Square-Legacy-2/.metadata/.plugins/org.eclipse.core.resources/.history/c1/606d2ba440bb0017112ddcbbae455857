...
import com.IB.SL.level.Level;
	...
	public class mace_Bronze extends Weapon {
		
		private transient  AnimatedSprite down;
		
		public mace_Bronze(int x, int y, int life, int amount, int slot) {
			RNGGen();
			this.x = x;
			this.y = y;
			this.xx = x;
