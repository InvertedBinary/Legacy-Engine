...
import com.IB.SL.entity.inventory.effects.Regen;
...
public class MendersBolt extends Projectile {
	...
	public MendersBolt(double x, double y, double dir) {
		super(x, y, dir);
		damage = 1;
		basicInitialization();
	}
	
	public MendersBolt(double x, double y, double dir, Mob mob) {
		super(x, y, dir);
		damage = 1 + (mob.stat_ATC / 10) + (mob.stat_MDF / 5);
		basicInitialization();
	}
	...
	public void basicInitialization() {
		...
		speed = 4;
		sprite = Sprite.rotate(Sprite.MendersBolt, angle);	
		manaCost = 0;
