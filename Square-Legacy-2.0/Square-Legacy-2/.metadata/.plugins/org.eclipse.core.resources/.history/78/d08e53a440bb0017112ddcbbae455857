...
import com.IB.SL.level.Level;
	...
	public class mace_Gazer extends Weapon {
		
		private transient  AnimatedSprite down;
		
		public mace_Gazer(int x, int y, int life, int amount, int slot) {
			RNGGen();
			this.x = x;
			this.y = y;
			this.xx = x;
		...
		public mace_Gazer(int slot) {
			RNGGen();
			basicInitialization(slot);
		}
		
		public void basicInitialization(int slot) {
			this.sprite = Sprite.mace_Gazer;
