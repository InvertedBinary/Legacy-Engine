...
public class FlameEsscence extends Item{
	
	public FlameEsscence(int x, int y, int life, int amount) {
		this.x = x;
		this.y = y;
		this.xx = x;
		this.yy = y;
	...
	public FlameEsscence() {
		basicInitialization();
	}
	
	public void basicInitialization() {
		this.sprite = Sprite.FlameEsscence;
		this.name = "Flame Esscence";
		this.price = "175";
		this.desc = "Craft\nItem";
		this.stackSize = 8;
